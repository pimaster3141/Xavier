...
static int __pyx_f_10helloworld_clip(int, int, int); /*proto*/
...
static int __pyx_f_10helloworld_clip(int __pyx_v_a, int __pyx_v_min_value, int __pyx_v_max_value) {
  int __pyx_r;
...
static PyObject *__pyx_f_10helloworld_compute(__Pyx_memviewslice __pyx_v_array_1, __Pyx_memviewslice __pyx_v_array_2, uint32_t __pyx_v_a, uint32_t __pyx_v_b, uint32_t __pyx_v_c) {
 ...
 */
      ...
      __pyx_v_tmp = __pyx_f_10helloworld_clip((*((uint32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array_1.data + __pyx_t_13 * __pyx_v_array_1.strides[0]) ) + __pyx_t_14 * __pyx_v_array_1.strides[1]) ))), 2, 10);
 ...
 */
      ...
      __pyx_v_tmp = ((__pyx_v_tmp * __pyx_v_a) + ((*((uint32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array_2.data + __pyx_t_14 * __pyx_v_array_2.strides[0]) ) + __pyx_t_13 * __pyx_v_array_2.strides[1]) ))) * __pyx_v_b));
 ...
 */
  ...
  __Pyx_AddTraceback("helloworld.compute", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "helloworld._memoryviewslice", /*tp_name*/
